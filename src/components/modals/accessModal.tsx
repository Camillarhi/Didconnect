      ...
      <ModalWrapper isOpen={isOpen}>
        <div className="w-[21.4375rem] h-[26.75rem] px-4 pt-4 pb-6 bg-[#191A2F] rounded-lg flex-col justify-start items-start gap-8 inline-flex">
          ...
          <div className="self-stretch justify-start items-start gap-2 inline-flex">
            <div
              className="grow shrink basis-0 px-6 py-2 rounded-full border border-violet-300 flex-col justify-center items-center gap-2.5 inline-flex cursor-pointer"
              onClick={close}
            >
            ...
            <div
              className="grow shrink basis-0 px-6 py-2 bg-red-700 rounded-full flex-col justify-center items-center gap-2.5 inline-flex cursor-pointer"
